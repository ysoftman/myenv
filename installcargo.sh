...
mpkgs["binsider"]="binsider"               # (https://github.com/orhun/binsider) Analyze ELF(Executable and Linkable Format) binaries(mac 에서 동작안함)
...
mpkgs["feroxbuster"]="feroxbuster"         # (https://github.com/epi052/feroxbuster) 웹 애플리케이션의 숨겨진 디렉터리,파일,엔드포인트를 탐색해 취약점 파악, SecLists(워드리스트)설치 필요
...
mpkgs["mcat"]="mcat"                       # (https://github.com/Skardyy/mcat) Terminal image, video, and Markdown viewer
mpkgs["mdcat"]="mdcat"                     # (https://github.com/swsnr/mdcat) cat for markdown (archived)
...
mpkgs["presenterm"]="presenterm"           # (https://github.com/mfontanini/presenterm) A markdown terminal slideshow tool
mpkgs["procs"]="procs"                     # (https://github.com/dalance/procs) ps 대체
mpkgs["qsv"]="qsv"                         # (https://github.com/dathere/qsv) csv,excel,sql file tool
...
mpkgs["rumdl"]="rumdl"                     # (https://github.com/rvben/rumdl) markdown linter and formatter, markdownlint-cli2 대체
...
mpkgs["syswatch"]="syswatch"               # (https://github.com/matthart1983/syswatch) htop, btop 등 대체
...
mpkgs["uv"]="uv"                           # (https://github.com/astral-sh/uv) pipenv, poetry 등 python version package manager 대체
mpkgs["weathr"]="weathr"                   # (https://github.com/Veirt/weathr) a terminal weather app with ascii animation
mpkgs["whome"]="whome"                     # (https://github.com/ardaku/whoami) whoami 대체
mpkgs["xan"]="xan"                         # (https://github.com/medialab/xan) csv file tool
